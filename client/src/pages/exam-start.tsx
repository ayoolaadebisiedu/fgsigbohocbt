...
export default function ExamStart() {
  ...
  const startExamMutation = useMutation({
    mutationFn: async () => {
      // Use client-side Firebase API directly
      return await createExamSession({
        examId,
        studentName,
        studentId,
      });
    ...
    onError: (error) => {
      ...
      toast({
        ...
        description: error instanceof Error ? error.message : "There was an error starting your exam session. Please try again.",
        variant: "destructive",
      });
    },
  });
